...
var (
	...
	projectImage = "example.com/keyline-operator:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting keyline-operator integration test suite\n")
...
var _ = BeforeSuite(func() {
	...
	_, err = utils.Run(cmd)
	ExpectWithOffset(1, err).NotTo(HaveOccurred(), "Operator did not become ready in time")
})
